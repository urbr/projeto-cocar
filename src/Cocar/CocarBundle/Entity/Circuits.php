 ...
 * @ORM\Entity(repositoryClass="Cocar\CocarBundle\Entity\CustomCircuitsRepository")
 */
class Circuits
{
    /**
     ...
     * @return Circuits
     */
    public function setEntity(\Cocar\CocarBundle\Entity\Entity $entity = null)
    {
        $this->entity = $entity;
     ...
     * @return Entity
     */
    public function addMachine(\Cocar\CocarBundle\Entity\Machine $machine)
    {
     ...
     */
    public function removeMachine(\Cocar\CocarBundle\Entity\Machine $machine)
    {
